...
<div class="">
	...
	<form on:submit|preventDefault={submit}>
		...
		<div class="flex flex-col items-end mb-6">
			...
			<button
				class="bg-primary-500 hover:bg-primary-500 text-white font-bold text-xl py-4 px-12 rounded focus:outline-none focus:shadow-outline"
				type="button"
			>
				Login
			</button>
		...
		<div class="text-center">
			<h3 class="text-gray-600">
				Don't have an account? <a class="text-primary hover:text-primary" href="/auth/register">
					Sign up
				</a>
			</h3>
		</div>
