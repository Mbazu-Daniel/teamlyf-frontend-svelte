...
<form on:submit|preventDefault={nextStep}>
	<h2 class="block text-gray-700 text-4xl font-bold mb-2">Where is your Workspace located?</h2>
	<p class="text-gray-700 text-xl mb-12">
		<span class="font-bold">Teamlyf</span> tailors your experience to resonate with your business
	</p>

	<div class="mb-4">
		<label class="block text-gray-700 text-xl font-bold mb-2" for="country">Country</label>
		<select
			id="country"
	...
	<div class="mb-4">
		<label class="block text-gray-700 text-xl font-bold mb-2" for="state">State</label>
		<select
			id="state"
			class="block appearance-none w-full bg-white border border-solid rounded-xl border-gray-700 hover:border-gray-500 px-4 py-4 leading-tight focus:outline-none focus:shadow-outline"
			bind:value={state}
	...
	<div class="mb-4">
		<label class="block text-gray-700 text-xl font-bold mb-2" for="city">City</label>
		<select
			id="city"
			class="block appearance-none w-full bg-white border border-solid rounded-xl border-gray-700 hover:border-gray-500 px-4 py-4 leading-tight focus:outline-none focus:shadow-outline"
			bind:value={city}
	...
	<div class="flex justify-between mt-8">
		...
		<button
			class="bg-primary-500 hover:bg-purple-700 text-white font-bold text-xl py-4 px-12 rounded focus:outline-none focus:shadow-outline"
			type="submit"
		>
			Next
		</button>
