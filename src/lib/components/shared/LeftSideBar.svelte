...
>
	<div class="relative h-full flex flex-col">
		<header class="flex items-center justify-between py-4 pr-6">
			<div class="flex items-center">
				<span class="flex items-center justify-center">
					<Avatar.Root>
						<Avatar.Image src="../../images/other-logo.png" alt="workspace logo" />
						<Avatar.Fallback class="bg-primary-500 text-white rounded-md">DM</Avatar.Fallback>
					</Avatar.Root>
				</span>
		...
		<button
			class="absolute top-4 -right-4 w-10 bg-primary-500 rounded-full transform transition-transform duration-300"
